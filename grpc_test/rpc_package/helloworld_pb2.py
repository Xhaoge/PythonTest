...
_HELLOWOELDSERVICE = _descriptor.ServiceDescriptor(
  name='HelloWoeldService',
  full_name='rpc_package.HelloWoeldService',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  serialized_start=94,
  ...
  _descriptor.MethodDescriptor(
    name='SayHello',
    full_name='rpc_package.HelloWoeldService.SayHello',
    index=0,
...
_sym_db.RegisterServiceDescriptor(_HELLOWOELDSERVICE)

DESCRIPTOR.services_by_name['HelloWoeldService'] = _HELLOWOELDSERVICE
